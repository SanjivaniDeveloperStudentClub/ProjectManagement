    ...
    <div class="container">
        ...
        <div class="tab-container">
            <div class="tabs" id="tabs">
                ...
                <a href="Action_Required_Notification.php"><button class="tab active" data-tab="action"><a style="text-decoration: none;" href="Action_Required_Notification.php">Action Required</button> </a>
