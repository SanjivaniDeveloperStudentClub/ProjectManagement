...
$query = "SELECT * FROM Project WHERE Organization_Name = '" . $userdetail['Organization_Name'] . "' AND Status = 'due'";
    ...
    <div class="container">
        ...
        <div class="tab-container">
            <div class="tabs" id="tabs">
                ...
                <a href="Action_Required_Notification.php"><button class="tab active" data-tab="action">Action Required</button> </a>
        ...
        if ($result  && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($estimated_completion < $currentDate) {
